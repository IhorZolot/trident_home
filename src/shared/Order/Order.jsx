	...
	return (
		<div>
			<div className='bg-yellow-400 py-4'>
				<h1 className='w-[375px] text-[#00204A]  text-[26px] font-medium font-Lato'>
					Leave a request and we will contact you
				</h1>
				<p className='w-[375px] text-[#00204A] text-sm not-italic font-light font-Lato'>
					A Trident garden room can transform your garden into a place that you will use all year round, also adding
				</p>
			</div>
			{/* ++++++++++++++++++++++++++++++++++++++++++++++++ */}
			<div className='flex justify-center items-center min-h-screeen py-4 px-2'>
