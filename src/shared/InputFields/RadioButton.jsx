	...
	return (
		<div className='flex flex-col gap-2 '>
			...
			<label className='flex gap-2 items-center'>
				<input className='border rounded-[11px] border-solid border-[#EBE9E6]' type='radio' name={type} value='yes' />
				<span className='text-[rgba(0,0,0,0.60)] text-[15px] font-light leading-[18px]'>yes</span>
				<input className='border rounded-[11px] border-solid border-[#EBE9E6]' type='radio' name={type} value='no' />
