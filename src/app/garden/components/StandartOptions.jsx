	...
	return (
		<div className='mb-6 lg:px-8'>
			...
			<div className='flex flex-col items-left lg:flex-row lg:justify-between lg:items-center '>
				<div>
					<div className='flex items-end justify-between text-mainBlue text-sm font-medium leading-[102.9%] border-b-2 border-solid border-black w-[375px] gap-6 px-2 lg:w-[600px] py-4'>
						<p>Series</p>
						<p className='w-1/3 lg:'>Dimensions, L x W x H (mm)</p>
						<p className='w-1/3'>External sq.m/Internal sq.m/Terrace sq.m</p>
					</div>
					<div className='flex items-center justify-between text-mainBlue text-sm font-medium leading-[102.9%] border-b-2 border-solid border-black w-[375px] gap-6 px-2 mb-6 lg:w-[600px] py-4'>
						<p className='w-1/3 bg-sectionGray py-6'>Basic Without terrace</p>
