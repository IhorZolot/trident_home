	...
	return (
		<Container>
			<div className='lg:flex justify-between py-8'>
				<div className='mb-12  text-[#00204A] lg: px-16'>
					<h1 className='text-[26px] font-medium leading-[45px] mb-4 lg:text-[46px] font-normal'>About us</h1>
					<p className='w-[357px] text-[26px] font-light leading-[29.8px] mb-6 lg:w-[595px] text-4xl leading-[45px]'>
					...
					<Image src={aboutus013} alt='img' className='mb-4 lg:hidden' />
					<div className='flex flex-col w-[357px] gap-4 text-[#00204A] text-sm font-light leading-[23px] lg:w-[595px] text-base'>
						<p>
