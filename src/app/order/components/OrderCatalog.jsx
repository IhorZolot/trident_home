	...
	return (
		<div className='relative flex items-center justify-center py-[60px] px-8 lg:h-[445px]'>
			...
			<div className='text-center text-white z-10'>
				<h1 className='text-2xl mb-6 lg:text-[46px] font-medium leading-[37px]'>Order catalogue</h1>
				<p className='text-sm font-medium lg:text-center lg:text-base lg:w-[498px] leading-[23.486px]'>
