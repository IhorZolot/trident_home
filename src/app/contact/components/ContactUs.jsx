...
const ContactUs = () => {
	return (
		<div className='lg:flex justify-around pb-[100px] relative'>
			<iframe
			...
			<div className='px-2  text-center w-full flex bg-white lg:w-1/3 justify-center flex-col py-6 lg:border-neutral-100 lg:shadow-[0px_0px_10px_0px_rgba(0,0,0,0.25)] border-solid lg:pb-[50px] absolute right-0 top-0 z-40'>
